...
// MARK: - Constants
var sendCodePath = "/phones/verification/start";
var verifyCodePath = "/phones/verification/check";
var baseUrl = config_1.default.get('twilio-base-url');
var apiKey = config_1.default.get('twilioKey');
var TwilioService = /** @class */ (function () {
    function TwilioService() {
    }
    // MARK: - Send verification code 
    TwilioService.prototype.sendVerificationCodeTo = function (phoneNumber, countryCode, via) {
    ...
    TwilioService.prototype.validateVerificationCode = function (phoneNumber, countryCode, code) {
        return __awaiter(this, void 0, void 0, function () {
            var payload;
            return __generator(this, function (_a) {
                switch (_a.label) {
